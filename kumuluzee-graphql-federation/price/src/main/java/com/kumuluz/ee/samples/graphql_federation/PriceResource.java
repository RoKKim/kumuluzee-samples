...
public class PriceResource {
    ...
    @Inject
    private PricesService productBean;
    ...
    public Product getProduct(@Name("productId") String productId) {
        return productBean.getProduct(productId);
    }

    @Mutation
    public Product addNewProductPrice(@Name("productPrice") Product product) {
        productBean.saveProduct(product);
        return product;
    }

    @Mutation
    public Boolean deleteProductPrice(@Name("productId") String productId) {
